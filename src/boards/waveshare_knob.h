...
#define HAS_HAPTIC       1   // DRV2605 mit LRA
#define HAS_AUDIO        0   // DAC nur auf die 3.5-mm-Klinke, kein Lautsprecher
#define HAS_LEDRING      0
#define KNOB_QUADRATURE  1   // echte Quadratur (mit Eigenheiten, siehe input_knob.cpp)
