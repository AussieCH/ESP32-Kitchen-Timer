...
// JC3636K718_knob_EN (pincfg.h / scr_st77916.h).
// ACHTUNG: unterscheidet sich komplett vom JC3636W518 und vom Waveshare-Knob -
// Display, Backlight und Touch liegen alle woanders.
#pragma once

#define BOARD_NAME       "Guition JC3636K718C"
// Haptik: am Geraet nachgemessen - der I2C-Scan beim Start findet 0x15 (Touch)
// UND 0x5A, und der DRV2605 antwortet. Weder das Herstellerdemo noch die
// kursierenden Pinouts erwaehnen ihn; er ist trotzdem bestueckt.
#define HAS_HAPTIC       1
#define HAS_AUDIO        1   // PCM5100A + eingebauter Lautsprecher
#define HAS_LEDRING      1   // WS2812, 13 LEDs
#define KNOB_QUADRATURE  0   // KEINE Quadratur - je ein Impuls pro Richtung
