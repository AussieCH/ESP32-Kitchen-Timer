...
clang++ -std=gnu++17 -O1 -w $INC \
  src/ui.cpp src/ui_splash.cpp src/ui_overview.cpp src/ui_active.cpp src/ui_egg.cpp src/ui_stopwatch.cpp src/ui_new.cpp src/ui_presets.cpp src/ui_settings.cpp \
